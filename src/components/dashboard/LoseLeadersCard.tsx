            ...
            <TableBody>
              {list.slice(0, 5).map((growth, idx) => (
                <TableRow key={idx} className="border-slate-100">
                  ...
                  <TableCell className="text-right font-mono font-bold text-rose-600">{growth.change}%</TableCell>
                  <TableCell className="text-center">
                    <Badge className="bg-rose-600 hover:bg-rose-600 text-white text-[8px]">
                      {growth.tier}
                    </Badge>
                  </TableCell>
                </TableRow>
